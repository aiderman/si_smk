                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <ul class="info-list clearfix">
                                                    <li><span class="inf">Nama </span> <span class="value"><?php echo $row3->nama_siswa; ?></span></li>
                                                    <li><span class="inf">NIS</span> <span class="value"><?php echo $row3->nis_siswa; ?></span></li>
                                                    <li><span class="inf">Alamat</span> <span class="value"> <?php echo $row3->alamat_siswa; ?></span></li>
                                                </ul>
                                            </div>
                                            <div class="col-md-6">
                                                <ul class="info-list">
                                                    <li><span class="inf">Tahun Masuk</span> <span class="value"><?php echo $row3->tahunmasuk_siswa; ?></span></li>
                                                    <li><span class="inf">Phone</span> <span class="value"> <?php echo $row3->hp_siswa; ?> </span></li>
                                                    <li><span class="inf">Email</span> <span class="value"><?php echo $row3->email_siswa; ?></span></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <!--End row-->
